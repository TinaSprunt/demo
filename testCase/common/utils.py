...
class Utils:
    ...
    def is_ok_key(self,expected_state_code,res):
        """
        断言对比stateCode值
        :param expected_state_code:
        :param re2:
        :return:
        """
        try:
            if expected_state_code == res["returnState"]["stateCode"]:
                return True
            return False
...
if __name__=="__main__":
    ...
    dic2 ={'permission': {'clusterManage': True,
                          'deviceControl': True,
                          'deviceManage': True,
                          'download': True,
                          'opmManage': True,
